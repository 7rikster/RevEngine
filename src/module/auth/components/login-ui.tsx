            ...
            <div className='flex-1 flex flex-col justify-center items-center px-12 py-16 bg-gradient-to-br from-zinc-900/50 to-transparent'>
                <div className='w-full max-w-md'>
                    ...
                    <button 
                        ...
                        disabled={isLoading}
                        className='cursor-pointer w-full py-4 px-6 bg-white hover:bg-zinc-500 border border-zinc-700 hover:border-zinc-600 text-black rounded-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-3 group'
                    >
